...
define('GREGOR_DAYS_PER_5_MONTHS',153);
...
$century=(int)($temp/GREGOR_DAYS_PER_400_YEARS);

// Calculate the year and day of year (1 <= dayOfYear <= 366).
$temp=((int)(($temp%GREGOR_DAYS_PER_400_YEARS)/4))*4+3;
$year=($century*100)+((int)($temp/GREGOR_DAYS_PER_4_YEARS));
$dayOfYear=(int)(($temp%GREGOR_DAYS_PER_4_YEARS)/4)+1;

// Calculate the month and day of month.
$temp=$dayOfYear*5-3;
$month=(int)($temp/GREGOR_DAYS_PER_5_MONTHS);
$day=(int)(($temp%GREGOR_DAYS_PER_5_MONTHS)/5)+1;
...
return((int)((((int)($year/100))*GREGOR_DAYS_PER_400_YEARS)/4)
       +(int)((($year%100)*GREGOR_DAYS_PER_4_YEARS)/4)
       +(int)(($month*GREGOR_DAYS_PER_5_MONTHS+2)/5)
       +$inputDay
       -GREGOR_SDN_OFFSET);
}
?>
