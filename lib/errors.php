...
define('EP_DISABLE_SQL',1312);
define('EP_IDENT_ABSENT',1313);
define('EP_IDENT_UNIQUE',1314);
define('EP_INVALID_GRP',1315);
define('EP_AUTHOR_ABSENT',1316);
define('EP_SOURCE_ABSENT',1317);
define('EP_TOPIC_ACCESS',1318);
define('EP_URL_ABSENT',1319);
define('EP_INDEX1_ABSENT',1320);
define('EP_NO_UP',1321);
