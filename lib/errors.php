...
define('EP_IMAGE_ABSENT',138);
define('EP_NO_IMAGE',139);
define('EP_LARGE_BODY_ABSENT',1310);
define('EP_TITLE_SQL',1311);
define('EP_IDENT_ABSENT',1312);
define('EP_IDENT_UNIQUE',1313);
define('EP_INVALID_GRP',1314);
define('EP_AUTHOR_ABSENT',1315);
define('EP_SOURCE_ABSENT',1316);
define('EP_TOPIC_ACCESS',1317);
define('EP_URL_ABSENT',1318);
define('EP_INDEX1_ABSENT',1319);
define('EP_NO_UP',1320);
define('EP_LOOP_UP',1321);
define('EP_TRACK_SQL',1322);
define('EP_LANG_ABSENT',1323);
define('EP_UP_APPEND',1324);
