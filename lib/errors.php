...
define('ET_NO_UP',124);
define('ET_LOOP_UP',125);
define('ET_NO_USER',126);
define('ET_NO_GROUP',127);
define('ET_BAD_PERMS',128);
define('ET_NO_APPEND',129);
...
define('EP_IDENT_ABSENT',139);
define('EP_IDENT_UNIQUE',1310);
define('EP_INVALID_GRP',1311);
define('EP_AUTHOR_ABSENT',1312);
define('EP_SOURCE_ABSENT',1313);
define('EP_TOPIC_ACCESS',1314);
define('EP_URL_ABSENT',1315);
define('EP_INDEX1_ABSENT',1316);
define('EP_NO_UP',1317);
define('EP_LOOP_UP',1318);
define('EP_LANG_ABSENT',1319);
define('EP_UP_APPEND',1320);
