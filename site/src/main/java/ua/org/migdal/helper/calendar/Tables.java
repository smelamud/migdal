...
public class Tables {
    ...
    public static String[] GREGORIAN_MONTH_RU_PC_SHORT = {"Янв", "Фев", "Мар", "Апр", "Май", "Июн",
            "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек"};
    public static String[] GREGORIAN_MONTH_RU_LC_SHORT = {"янв", "фев", "мар", "апр", "май", "июн",
            "июл", "авг", "сен", "окт", "ноя", "дек"};
    public static String[] GREGORIAN_MONTH_RU_NOM_PC_LONG = {"Январь", "Февраль", "Март", "Апрель", "Май", "Июнь",
            "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"};
    public static String[] GREGORIAN_MONTH_RU_NOM_LC_LONG = {"январь", "февраль", "март", "апрель", "май", "июнь",
            "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь"};
    ...
    public static String[] JEWISH_DOW_RU_PC_LONG = {"Йом-ришон", "Йом-шейни", "Йом-шлиши", "Йом-рвии", "Йом-хамиши",
            "Йом-шиши", "Шабат"};
    public static String[] JEWISH_DOW_RU_LC_LONG = {"йом-ришон", "йом-шейни", "йом-шлиши", "йом-рвии", "йом-хамиши",
            "йом-шиши", "шабат"};
